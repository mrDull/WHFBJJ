...
app.title("Roblox JJ Automator by mrDull / Dreamsrotting ")

# --- Widgets ---
label_title = ctk.CTkLabel(app, text="Auto Roblox JJ Script <3", font=("Arial", 22))
label_title.pack(pady=10)

url_label2 = ctk.CTkLabel(app, text="any problems? dm @dreamsrotting on discord", font=("Arial", 15, "underline"), fg_color="transparent")
url_label2.pack(pady=1)

url_label3 = ctk.CTkLabel(app, text="OR MrDull on Github", font=("Arial", 15, "underline"), fg_color="transparent")
url_label3.pack(pady=2)
...
def on_press(key):
    ...
    try:
        if key == Key.f5:  # Start the script when 'J' is pressed
            ...
            CTkMessagebox(title="Done", message="JJ script cut short!", icon="cancel")    
